...
# by assigning a unique alphabetical character to each gift. After each gift was
# assigned a character, the gift organizer Elf then joined the characters to
...
sortGiftCode = (code) ->
  code.split('').sort((a, b) -> a.localeCompare(b)).join('')

# apparently the localeCompare isn't necessary
# sortGiftCode = (code) ->
#   code.split('').sort((a, b) -> a.localeCompare(b)).join('')
