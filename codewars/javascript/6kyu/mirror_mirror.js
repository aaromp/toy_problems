// Write a function evilTwin(obj) which returns a new object with all the same
// properties as obj, and with an additional property hasGoatee set to true.
